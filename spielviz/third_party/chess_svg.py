# SpielViz: We copy-pasted from chess package implementation:
# https://raw.githubusercontent.com/niklasf/python-chess/v1.4.0/chess/svg.py
# We need to modify this to add additional rendering of public/private squares.
...
def board(board: Optional[chess.BaseBoard] = None, *,
    ...
    colors: Dict[str, str] = {},
    flipped: bool = False,
    style: Optional[str] = None) -> ET.Element:
  """
